...
This repository contains a full optimized code that calculates Charge Modulation/IR spectrum, polaron coherence and photoluminiscence for both homo and Donor Acceptor polymers. The program has been uniquely developed in the Spano group. You will learn how to code using Petsc and Slepc along with MPI. The code can run on multiple nodes in a single processor or multiple processors.
